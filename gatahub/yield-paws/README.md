...
description: >-
  ...
  lifting a single paw. The second of Yield series.
...
Each month, this Yield series collection by GATA HUB will provide you with&#x20;

• Epoch Rewards (90% of yield revenue gets distributed to YP holders in $PHOTON)

• Buy & Burn program (5% of yield gets used to sweep floor & to reduce supply continuously)&#x20;

• Yield Raffle (5% of yield gets raffled with 3 random YPs winning; each YP = 1 ticket)
